...
namespace DBDemo2 {
    ...
    public partial class StudentDataDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int Id, string Name, string Branch, int Semester) {
...
namespace DBDemo2.StudentDataDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Semester = 1 AND [Semester] IS NULL) OR ([Semester] = @Original_Semester)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [Name], [Branch], [Semester]) VALUES (@Id, @Na" +
                "me, @Branch, @Semester);\r\nSELECT Id, Name, Branch, Semester FROM Student WHERE (" +
                "Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [Name] = @Name, [Branch] = @Branch, [Semester] = @Semester WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Semester = 1 AND [Semester] IS NULL) OR ([Semester] = @Original_Semester)));
SELECT Id, Name, Branch, Semester FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBDemo2.Properties.Settings.Default.StudentDataConnectionString;
        }
        ...
        public virtual int Fill(StudentDataDataSet.StudentDataTable dataTable) {
        ...
        public virtual StudentDataDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDataDataSet.StudentDataTable dataTable = new StudentDataDataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDataDataSet.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Branch, global::System.Nullable<int> Original_Semester) {
        ...
        public virtual int Insert(int Id, string Name, string Branch, global::System.Nullable<int> Semester) {
        ...
        public virtual int Update(int Id, string Name, string Branch, global::System.Nullable<int> Semester, int Original_Id, string Original_Name, string Original_Branch, global::System.Nullable<int> Original_Semester) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Branch, global::System.Nullable<int> Semester, int Original_Id, string Original_Name, string Original_Branch, global::System.Nullable<int> Original_Semester) {
            return this.Update(Original_Id, Name, Branch, Semester, Original_Id, Original_Name, Original_Branch, Original_Semester);
        }
    }
