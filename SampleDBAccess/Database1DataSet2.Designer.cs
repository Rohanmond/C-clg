...
namespace SampleDBAccess {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProjectsDataTable : global::System.Data.TypedTableBase<ProjectsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProjectsRow AddProjectsRow(int ProjectId, int StudentId) {
        ...
        public partial class ProjectsRow : global::System.Data.DataRow {
            ...
            public int StudentId {
                get {
                    return ((int)(this[this.tableProjects.StudentIdColumn]));
                }
                set {
                    this[this.tableProjects.StudentIdColumn] = value;
                }
            }
        }
...
namespace SampleDBAccess.Database1DataSet2TableAdapters {
    ...
    public partial class ProjectsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Projects] WHERE (([ProjectId] = @Original_ProjectId) AND ([Stu" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Projects] ([ProjectId], [StudentId]) VALUES (@ProjectId, @Stud" +
                "entId);\r\nSELECT ProjectId, StudentId FROM Projects WHERE (ProjectId = @ProjectId" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Projects] SET [ProjectId] = @ProjectId, [StudentId] = @StudentId WH" +
                "ERE (([ProjectId] = @Original_ProjectId) AND ([StudentId] = @Original_StudentId)" +
                ");\r\nSELECT ProjectId, StudentId FROM Projects WHERE (ProjectId = @ProjectId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SampleDBAccess.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProjectId, StudentId FROM dbo.Projects";
        ...
        public virtual int Delete(int Original_ProjectId, int Original_StudentId) {
        ...
        public virtual int Insert(int ProjectId, int StudentId) {
        ...
        public virtual int Update(int ProjectId, int StudentId, int Original_ProjectId, int Original_StudentId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int StudentId, int Original_ProjectId, int Original_StudentId) {
            return this.Update(Original_ProjectId, StudentId, Original_ProjectId, Original_StudentId);
        }
    }
